...
plt.plot(df['twotheta'], df[' yobs'], color='yellow', label='Yobs')
plt.plot(df['twotheta'], df[' bkg'], color='black', label='bkg')
# plt.plot(df['#twotheta'], df['diff'],color = 'green',label='diff')
plt.plot(df['twotheta'], df[' ycal'], color='red', label='Ycal')
...
############################################################################
############# Encontrar os máximos relativos ao angulos #################
...
x1=df[x]
peaks,_= find_peaks(y, height=0.2,prominence=150) #Calcula o máximos
plt.plot(x1[peaks], y[peaks], "x") # Plota os máximos em conformidade com a colunas relacionada
plt.show()
##############################################################################
############################################################################
